...
import com.kiu.gym_management_system.service.CategoryManager;
...
public class CategoryManagerService implements CategoryManager {
    ...
    public Response getCategory(int id) {
        ...
        response.setMsg("Get Category");
        return response;
    }

    @Override
    public Response getFilterCategory(int status) {
        Response response = new Response();
        response.setCode(200);
        response.setData(categoryRepository.findByStatus(status));
        response.setMsg("Get filter Category Data");
        return response;

    }

    @Override
    public Response editCategory(String empID, CategoryModel categoryModel, int id) {
...
//            response.setData(scheduleRepository.findById(obj.getId()));
    ...
    @Override
    public Response deleteCategory(int status, int id, String empID) {
...
//        }
        ...
        if (categoryEntityOptional.isPresent()) {
            CategoryEntity obj = categoryEntityOptional.get();
