...
//    }
    ...
    public Response editMaintenance(String empID, MaintenanceModel maintenanceModel, int id) {
        ...
        if (maintenanceEntityOptional.isPresent()) {
            ...
            } else if (maintenanceModel.getStatus() == 3) {
                completeMaintenance(id, 3, empID, maintenanceModel);
            }
...
//            response.setData(scheduleRepository.findById(obj.getId()));
    ...
    public void completeMaintenance(int id, int status, String empID, MaintenanceModel maintenanceModel) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        ...
        if (maintenanceEntityOptional.isPresent()) {
            ...
            obj.setTitle(maintenanceModel.getTitle());
            obj.setTaskID(maintenanceModel.getTaskID());
            obj.setTaskTitle(maintenanceModel.getTaskTitle());
            obj.setDescription(maintenanceModel.getDescription());
